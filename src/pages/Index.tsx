    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[600px] bg-gradient-to-r from-blue-600 to-purple-700 flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-8">Discover the perfect property with our comprehensive real estate platform</p>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">Discover our hand-picked selection of premium properties</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link to="/buy" className="group">
              <Card className="h-64 relative overflow-hidden hover:shadow-2xl transition-all duration-300 cursor-pointer transform hover:-translate-y-3">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-blue-700 group-hover:from-blue-600 group-hover:to-blue-800 transition-all duration-300"></div>
                <CardContent className="relative z-10 h-full flex flex-col justify-center items-center text-white text-center p-8">
                  ...
                  <h3 className="text-2xl font-bold mb-3">Buy a Home</h3>
                  <p className="text-blue-100">Find your perfect home from thousands of listings</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/sell" className="group">
              <Card className="h-64 relative overflow-hidden hover:shadow-2xl transition-all duration-300 cursor-pointer transform hover:-translate-y-3">
                <div className="absolute inset-0 bg-gradient-to-br from-green-500 to-green-700 group-hover:from-green-600 group-hover:to-green-800 transition-all duration-300"></div>
                <CardContent className="relative z-10 h-full flex flex-col justify-center items-center text-white text-center p-8">
                  <DollarSign className="h-16 w-16 mb-4 group-hover:scale-110 transition-transform duration-300" />
                  <h3 className="text-2xl font-bold mb-3">Sell a Home</h3>
                  <p className="text-green-100">List your property and connect with buyers</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link to="/rent" className="group">
              <Card className="h-64 relative overflow-hidden hover:shadow-2xl transition-all duration-300 cursor-pointer transform hover:-translate-y-3">
                ...
                <CardContent className="relative z-10 h-full flex flex-col justify-center items-center text-white text-center p-8">
                  ...
                  <h3 className="text-2xl font-bold mb-3">Rent a Home</h3>
                  <p className="text-purple-100">Discover rental properties in your area</p>
                </CardContent>
              </Card>
            </Link>
          </div>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Home Haven</h3>
              <p className="text-gray-300">Your trusted partner in real estate and home services.</p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><Link to="/repairing" className="hover:text-white">Repairs</Link></li>
              </ul>
            </div>
            <div>
